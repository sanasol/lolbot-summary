    ...
    private function generateGrokResponse(string $messageText, string $username, string $chatContext = ''): ?string
    {
        ...
        try {
            ...
            $shouldRespondPrompt = "You are an assistant that determines if a message mentioning a bot requires a response." .
                "Analyze this message and determine if it's asking the bot to do something, talking about the bot, or just mentioning it in passing. Respond only if bot mentioned in the message. Example mentions: bot, железяка, бот, ботик" .
